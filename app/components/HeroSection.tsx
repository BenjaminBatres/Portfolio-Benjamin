...
export default function HeroSection() {
  return (
    <div className="min-h-[calc(100vh-120px)] flex flex-col items-center lg:flex-row gap-10 lg:gap-20 px-5 sm:px-8 max-w-370 mx-auto overflow-hidden relative pt-20 lg:pt-0">
