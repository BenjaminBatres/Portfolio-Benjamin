...
export default function Menu({ links, socialLinks }: MenuProps) {
  ...
  return (
    <div className="lg:hidden">
      ...
      />
      <div
        className={`${isOpen ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-full pointer-events-none"} absolute top-19 w-full left-0 transition-all duration-300 z-10`}
      >
